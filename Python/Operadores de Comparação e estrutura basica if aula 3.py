    """
== Igual : Verifica sem um valor é igual ao outro
...
estrutura if --> if n1 + n2: 
                    print("precisa dos espaços certinhos ")
"""
...
if numero1 >= numero2:
    print("Número 1 é maior ou Igual ao Número 2")

if numero1 < numero2:
    print("Número 1 é menor que Número 2")

if numero1 <= numero2:
    print("Número 1 é menor ou Igual ao Número 2")
